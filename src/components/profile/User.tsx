...
const User: React.VFC = () => {
  ...
  return (
    <div className="py-15 dark:bg-gray-700 bg-gray-200 pt-12">
      <div className="max-w-xl mx-auto bg-white dark:bg-gray-900 dark:text-white rounded-lg overflow-hidden shadow-xs">
        <div className="border-b px-4 pb-6">
            ...
            <div className="py-2">
              <h3 className="font-bold text-2xl text-gray-800 dark:text-white mb-1">
                <a
                  ...
                  target="_blank"
                  className="flex-1 rounded-full border-2 border-gray-400 dark:border-gray-700 font-semibold text-black text-center dark:text-white px-4 py-2 cursor-pointer"
                >
                  Aung Thu Oo
                </a>
              </h3>
          ...
          <div className="flex gap-2 px-2">
            <button
              ...
              className="flex-1 rounded-full bg-blue-600 dark:bg-blue-800 text-white text-center dark:text-white antialiased font-bold hover:bg-blue-800 dark:hover:bg-blue-900 px-4 py-2"
            >
              Download Resume
            </button>
        ...
        <div className="px-4 py-4 dark:text-white ">
          ...
          <div className="py-4">
            ...
            <p>
              ...
              learning new skills, and solving challenging problems. My mission
              is to create impactful and innovative solutions that make a
