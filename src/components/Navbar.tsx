  ...
  <div>
    <nav
      ...
      <div className="flex w-full flex-wrap items-center justify-between px-3">
        <div className="ms-2">
          <a className="text-xl text-black dark:text-white" href="#">Profile</a>
        </div>
        <button
          ...
          <div
            ...
            <div
              ...
              {/* <a
                ...
                >Home</a
              > */}
              <InteractiveLink to="/home" className="text-black dark:text-white lg:px-2">
                Home
              </InteractiveLink>
            ...
            <div
              ...
              {/* <a
                ...
                >Features</a
              > */}
              <InteractiveLink to="/profile" className="p-0 text-black/60 transition duration-200 hover:text-black/80 hover:ease-in-out focus:text-black/80 active:text-black/80 motion-reduce:transition-none dark:text-white/60 dark:hover:text-white/80 dark:focus:text-white/80 dark:active:text-white/80 lg:px-2">
                Profile
              </InteractiveLink>
            </div>
            <div
