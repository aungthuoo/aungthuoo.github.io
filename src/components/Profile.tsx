  ...
  <div>
    ...
    <article className="mb-4 break-inside break-inside-avoid p-6 rounded-xl bg-white flex flex-col bg-clip-border max-w-md">
        ...
        <div className="flex justify-between gap-1 mb-1">
            ...
            <img className="max-w-full rounded-tl-lg" src="https://images.pexels.com/photos/2457278/pexels-photo-2457278.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260" />
            </a>
            <a className="flex" href="#">
            <img className="max-w-full" src="https://images.pexels.com/photos/1343537/pexels-photo-1343537.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260" />
            </a>
            <a className="flex" href="#">
            <img className="max-w-full rounded-tr-lg" src="https://images.pexels.com/photos/327331/pexels-photo-327331.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260" />
            </a>
        </div>
        <div className="flex justify-between gap-1">
            <a className="flex" href="#">
            <img className="max-w-full rounded-bl-lg" src="https://images.pexels.com/photos/1279813/pexels-photo-1279813.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260" />
            </a>
            <a className="flex" href="#">
            <img className="max-w-full rounded-br-lg" src="https://images.pexels.com/photos/1209843/pexels-photo-1209843.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260" />
            </a>
        </div>
        </div>
        <p>
        ...
        <input className="pt-2 pb-2 pl-3 w-full h-11 bg-slate-100 rounded-lg placeholder:text-slate-600 font-medium pr-20" type="text" placeholder="Write a comment" />
        <span className="flex absolute right-3 top-2/4 -mt-3 items-center">
            ...
            <svg className="fill-blue-500" style={{width: '24px', height: '24px'}} viewBox="0 0 24 24">
        ...
        <div className="w-full">
            <a href="#" className="py-3 px-4 w-full block bg-slate-100 text-center rounded-lg font-medium hover:bg-slate-200 transition ease-in-out delay-75">Show more comments</a>
        </div>
        </div>
    </article>
